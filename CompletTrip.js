...
<View style={styles.row}>
  ...
  >
    <Text style={{ color: 'white', fontWeight: 'bold', textAlign:'center' }}>View Complet Trip </Text>
  </TouchableOpacity>
    </View>
  );
};
...
const CompletTrip = () => {
  ...
  const fetchTripsData = (driverId) => {
    fetch(`http://www.aimcabbooking.com/admin/Trip_Complete.php?driverid=${driverId}`) // Use the correct API endpoint
